...
public class MoveAwayPPAction implements Action {
		 ...
		 if (game.doesGhostRequireAction(ghost))        //if it requires an action
	        {
			 int[] pPills = game.getActivePowerPillsIndices();
				...
				return game.getApproximateNextMoveAwayFromTarget(game.getGhostCurrentNodeIndex(ghost),PP , game.getGhostLastMoveMade(ghost), DM.PATH);
	        }
		return MOVE.NEUTRAL;
	}
