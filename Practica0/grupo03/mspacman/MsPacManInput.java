...
public class MsPacManInput extends Input {
	...
	public int getClosestChasingDistance() {
		//return game.getShortestPathDistance(pc, gs.get(closestChasing));
		if(game.getGhostLairTime(GHOST.BLINKY) > 0) {
			return game.getShortestPathDistance(pc, gs.get(GHOST.BLINKY));
		}
		else {
			return game.getShortestPathDistance(pc, gs.get(closestChasing), game.getPacmanLastMoveMade());
		}
