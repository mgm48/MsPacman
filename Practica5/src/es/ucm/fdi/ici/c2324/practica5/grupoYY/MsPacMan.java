...
import es.ucm.fdi.ici.c2324.practica5.grupoYY.ghosts.actions.GhostsChaseAction;
...
import es.ucm.fdi.ici.c2324.practica5.grupoYY.mspacman.actions.ChaseAction;
import es.ucm.fdi.ici.c2324.practica5.grupoYY.mspacman.actions.EatPillsAction;
...
public class MsPacMan extends PacmanController {
	...
	public MsPacMan()
	{
		setName("Pacpacpacpac");

		fuzzyMemory = new MsPacManFuzzyMemory();
		
		Action[] actions = {new GoToPPillAction(), new RunAwayAction(), new ChaseAction(), new EatPillsAction()};//TODO
